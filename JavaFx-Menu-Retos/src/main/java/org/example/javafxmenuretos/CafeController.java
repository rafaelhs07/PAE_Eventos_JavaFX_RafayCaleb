...
public class CafeController {
    ...
    private LoteCafe loteSeleccionado;
    ...
    private void editarLote() {
        ...
        txtCodigo.setText(
                loteSeleccionado.getCodigo()
        );

        txtProductor.setText(
                loteSeleccionado.getProductor()
        );

        txtMunicipio.setText(
                loteSeleccionado.getMunicipio()
        );

        txtPeso.setText(
                String.valueOf(
                        loteSeleccionado.getPeso()
                )
        );

        comboCalidad.setValue(
                loteSeleccionado.getCalidad()
        );

        tablaLotes.getItems().remove(
                loteSeleccionado
        );
    }
